...
class _JobsDashboardState extends State<JobsDashboard> with TickerProviderStateMixin {
  // Filter Controllers
  ...
  Widget _buildDashboardContent(BuildContext context) {
    final jobProvider = Provider.of<JobPostingProvider>(context);
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: _JobsDashboardState.spacing),
